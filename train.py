...
from libs.utils import entropy_regularization
...
def train_step(model, optimizer, loss_fn, dataset, metrics):
    ...
    for (batch, (x, adj, label)) in enumerate(dataset):
        with tf.GradientTape() as tape:
            ...
            loss += entropy_regularization(pred, FLAGS.beta_erl)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--prefix', type=str, default='ACGT', 
    ...
    parser.add_argument("--reload_ckpt", type=str2bool, default=False, 
